...
Keep the service; repoint the label. The parts worth preserving are the ones
...
infrastructure — a gift-links labeler reuses all of it and changes only
`subjectsToLabel` and the label value.
...
checkable rather than evaluative.
