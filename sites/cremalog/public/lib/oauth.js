// oauth.js — browser-side atproto OAuth (public client), for cremalog.bisks.net.
//
// Copied and adapted from sites/tacocounter/public/lib/oauth.js (same repo),
...
//
// Scope: narrowed per notes/50-oauth-scopes.md — cremalog only ever creates
// its own net.bisks.cremalog.review records, nothing else. Must match
...
const ORIGIN = location.origin; // https://cremalog.bisks.net (or localhost in dev)
const MOUNT = "";
...
const SCOPE = "atproto repo:net.bisks.cremalog.review?action=create";
