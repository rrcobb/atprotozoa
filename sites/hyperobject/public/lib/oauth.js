// oauth.js — browser-side atproto OAuth (public client), for hyperobject.bisks.net.
//
// Copied and trimmed from sites/velvetrope/public/lib/oauth.js (same repo),
...
const ORIGIN = location.origin; // https://hyperobject.bisks.net (or localhost in dev)
...
const DB_NAME = "hyperobject-oauth";
const STORE = "session";
