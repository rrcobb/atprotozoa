...
// the follows/moots graph stuff, which this site has no use for). Everything
// here reads public, unauthenticated endpoints (the AppView + each user's own
// PDS) — no session needed. Writing (createRecord/putRecord) stays in
