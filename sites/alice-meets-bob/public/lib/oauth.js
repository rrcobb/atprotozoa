...
// bisks.net/alice-meets-bob.
//
// Copied and trimmed from padmoot/public/lib/oauth.js (same repo), itself
// adapted from paintmoot/trigrams/mino.mobi's airchat/oauth/flow.js. Public
// client:
...
// Canonical host is alice-meets-bob.bisks.net, so there is no mount prefix.
// The site still answers at bisks.net/alice-meets-bob, but OAuth only works on
// the canonical host: client_id must equal the URL the metadata is served from.
...
const DB_NAME = "alice-meets-bob-oauth";
const STORE = "session";
