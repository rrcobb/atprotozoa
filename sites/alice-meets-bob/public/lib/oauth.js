...
// Mounted at bisks.net/alice-meets-bob — location.origin alone drops the
// path, so the mount prefix has to be appended for any URL this site writes
// about itself.
export const MOUNT = "/alice-meets-bob";
