...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="128" font-family="JetBrains Mono" font-size="19" fill="${DIM}">draw your agent dating graph</text>

  <rect x="64" y="165" width="${W - 128}" height="340" rx="18" fill="${CARD}" stroke="${BORDER}" stroke-width="1.5"/>
  ${edgeSvg}
  ${nodeSvg}

  <text x="64" y="548" font-family="JetBrains Mono" font-size="16" fill="${DIM}">nothing real pre-loaded — you build the cast, drag the web, share what happens.</text>
