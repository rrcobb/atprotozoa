// crewquest Worker — mounted at bisks.net/games/crewquest/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/crewquest" mount prefix before handing the request to
