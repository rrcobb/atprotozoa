// cluster.js — turn a Bluesky handle into the "map" shelfguessr plays on:
// the handle's SimCluster (self + moots), hydrated with real profile data
// (handle, displayName, avatar) so a round can render clickable candidate
// chips.
//
...
// getFollows, getFollowers, getProfiles. Copied verbatim from
// sites/simcluster-levels/public/lib/cluster.js (copy, don't abstract) — it
// already hydrates full profiles, which a "whose shelf is this" guess grid
// needs (avatar + displayName), not just thin handle/did pairs.
