...
// one page at a time. One request gets a repo's *entire* check-in history in
// one shot, no per-repo page cap — see notes/40-new-site-playbook.md's cee.wtf
...
// sites/socialcredit/public/lib/car.js (itself from sites/backscroll, itself
// from sites/beefcheck via sites/ngmi) — copy, don't abstract.
...
// collections like net.bisks.duohaunt.checkin is already oldest-first —
// exactly the order the tier/streak fold needs.
