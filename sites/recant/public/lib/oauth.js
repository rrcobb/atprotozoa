// oauth.js — browser-side atproto OAuth (public client), for recant.bisks.net.
//
// Copied and trimmed from sites/duohaunt/public/lib/oauth.js (same repo),
...
// narrow grant: `repo:net.bisks.recant.apology?action=create` — writes your
// apology as a plain record to your own PDS, nothing else. Not the old
...
const ORIGIN = location.origin; // https://recant.bisks.net (or localhost in dev)
export const MOUNT = ""; // canonical host is recant.bisks.net — no path mount
...
const SCOPE = "atproto repo:net.bisks.recant.apology?action=create";
