...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="328" font-family="JetBrains Mono" font-size="16" fill="${DIM}">Full wall-text plaques for every site the bot</text>
  <text x="64" y="354" font-family="JetBrains Mono" font-size="16" fill="${DIM}">has ever built: provenance, wing, tradition,</text>
  <text x="64" y="380" font-family="JetBrains Mono" font-size="16" fill="${DIM}">and critical reception — including its own.</text>
