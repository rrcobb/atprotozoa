// Generates public/og.png — the Open Graph preview card for quadrants. Hand-
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="140" font-family="JetBrains Mono" font-weight="800" font-size="66" fill="${INK}">quadrants</text>
  <text x="64" y="188" font-family="JetBrains Mono" font-size="22" fill="${MUTED}">make your own <tspan fill="${ACCENT}">alignment chart</tspan></text>

  <text x="64" y="270" font-family="JetBrains Mono" font-size="17" fill="${MUTED}">lay out any 2x2 grid, drop your own</text>
  <text x="64" y="296" font-family="JetBrains Mono" font-size="17" fill="${MUTED}">reference points, no login needed.</text>
  <text x="64" y="322" font-family="JetBrains Mono" font-size="17" fill="${MUTED}">sign in with Bluesky to plot your own spot,</text>
  <text x="64" y="348" font-family="JetBrains Mono" font-size="17" fill="${MUTED}">written straight to your PDS.</text>

  <text x="64" y="560" font-family="JetBrains Mono" font-weight="700" font-size="20" fill="${ACCENT}">bisks.net/quadrants</text>
