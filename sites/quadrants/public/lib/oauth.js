// oauth.js — browser-side atproto OAuth (public client), for bisks.net/quadrants.
//
// Copied and trimmed from padmoot/public/lib/oauth.js (same repo). Public client:
...
// narrowed to our own net.bisks.quadrants.position collection only — no
...
const SCOPE = "atproto repo:net.bisks.quadrants.position";
