...
// Mounted at bisks.net/docmoot — location.origin alone drops the path, so the
// mount prefix has to be appended for any URL docmoot writes about itself.
export const MOUNT = "/docmoot";
