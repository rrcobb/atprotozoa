// idea-island Worker — mounted at bisks.net/idea-island/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/idea-island" mount prefix before handing the request to the
