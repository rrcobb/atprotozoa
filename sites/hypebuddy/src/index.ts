// hypebuddy Worker — hypebuddy.bisks.net
//
...
// site/hostname (this one) so it stopped sharing an address with the
// restored beat-up game at sites/beatupbuddy. All the game logic and the
// AppView avatar fetch happen client-side in public/game.js — this Worker's
...
// og:title/description is needed for a shared "I hyped up @mfzx.net N
// times" link to actually show N in the unfurl instead of the generic card.
