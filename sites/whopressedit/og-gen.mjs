// Generates public/og.png — the Open Graph preview card for whopressedit.
//
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="660" y="270" font-family="JetBrains Mono" font-weight="800" font-size="46" fill="${INK}">there is (again) one button</text>
  <text x="660" y="316" font-family="JetBrains Mono" font-size="20" fill="${MUTED}">one, shared by every visitor, resets weekly.</text>
  <text x="660" y="346" font-family="JetBrains Mono" font-size="20" fill="${MUTED}">press it and your state (or country) gets</text>
  <text x="660" y="376" font-family="JetBrains Mono" font-size="20" fill="${MUTED}">logged and shown here until the reset.</text>

  <text x="660" y="460" font-family="JetBrains Mono" font-weight="700" font-size="22" fill="${RED}">whopressedit.bisks.net</text>
</svg>`;
