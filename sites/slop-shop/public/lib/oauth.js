// oauth.js — browser-side atproto OAuth (public client), for slop-shop.bisks.net.
// Copied from sites/trigrams/public/lib/oauth.js (itself adapted from mino.mobi's
// airchat/oauth/flow.js, minormobius/agent01), thank you. Theirs is a confidential
// client in a Worker (server-held signing key, private_key_jwt assertions, state+
// tokens in D1). Ours is a PUBLIC client in the browser:
