...
// anonymously (api.bsky.app, CORS *, no auth). Copied from
// simcluster-alignment/public/lib/cluster.js (itself trimmed from
// grand-moot-auto, mootdrone, clustercrawl, simcluster — copy, don't
// abstract), with one addition: profileOf keeps `description` (the bio),
// which getFollows/getFollowers already return for free, so villainy.js
// gets bio text to score without an extra fetch per member.
