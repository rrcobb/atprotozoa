// trigramonopoly Worker — mounted at bisks.net/trigramonopoly/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/trigramonopoly" mount prefix before handing the request to the
