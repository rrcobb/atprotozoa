// mootcraft Worker — mounted at bisks.net/games/mootcraft/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/mootcraft" mount prefix before handing the request
