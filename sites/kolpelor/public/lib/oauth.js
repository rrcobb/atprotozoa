// oauth.js — browser-side atproto OAuth (public client), for kolpelor.bisks.net.
//
...
const ORIGIN = location.origin; // https://kolpelor.bisks.net (or localhost in dev)
