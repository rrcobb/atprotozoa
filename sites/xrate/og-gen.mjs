// Generates public/og.png — the Open Graph preview card for xrate.
// Hand-drawn SVG at the canonical OG size: a little converter panel showing
// a sample conversion. Rasterised with @resvg/resvg-js (pure native module,
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <!-- left: wordmark + pitch -->
  <text x="64" y="150" font-family="JetBrains Mono" font-weight="800" font-size="66" fill="url(#title)">xrate</text>
  <text x="64" y="200" font-family="JetBrains Mono" font-size="20" fill="${DIM}">live currency</text>
  <text x="64" y="228" font-family="JetBrains Mono" font-size="20" fill="${DIM}"><tspan fill="${ACCENT2}">converter</tspan></text>

  <text x="64" y="300" font-family="JetBrains Mono" font-size="16" fill="${DIM}">165 currencies, daily reference rates</text>
  <text x="64" y="326" font-family="JetBrains Mono" font-size="16" fill="${DIM}">from the European Central Bank. Type</text>
  <text x="64" y="352" font-family="JetBrains Mono" font-size="16" fill="${DIM}">an amount, pick two currencies, done.</text>

  <text x="64" y="560" font-family="JetBrains Mono" font-weight="700" font-size="19" fill="${ACCENT}">xrate.bisks.net</text>
  ...
  <text x="622" y="180" font-family="JetBrains Mono" font-weight="800" font-size="42" fill="${ACCENT}">86.09 EUR</text>
  ${rowSvg}
</svg>`;
