// moot-bingo Worker — mounted at bisks.net/games/moot-bingo/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/moot-bingo" mount prefix before handing the request to
