// pixel-fishing Worker — mounted at bisks.net/pixel-fishing/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/pixel-fishing" mount prefix before handing the request to the
