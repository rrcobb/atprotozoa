// identity.js — resolve an account's PDS from its DID document, so their
// full repo (every post they've ever made, not a page-capped AppView sample)
// can be pulled straight from the source over com.atproto.sync.getRepo.
// Copied and trimmed from sites/backscroll's lib/identity.js (copy, don't
// abstract) — typecheck only needs the PDS lookup.
