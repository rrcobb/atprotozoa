...
// followers), which mootroast loads into the drum roaster as beans.
// latestPost() is unused here but left in place (copy, don't trim). Reads
// Bluesky's PUBLIC AppView anonymously (public.api.bsky.app, CORS *, no
// auth): resolveHandle, getFollows, getFollowers, getProfile,
// getAuthorFeed. Copied from dial-a-mutual/lib/moots.js (copy, don't
// abstract).
