// claudoku engine — killer sudoku generation + solving, no dependencies.
//
...
// board for a win).
//
// Exposed as `window.Claudoku` in the browser, `module.exports` under node
...
(function (global) {
  ...
  function dailySeed(date) {
    return "claudoku-" + utcDateString(date);
  }
  ...
  if (typeof module !== "undefined" && module.exports) module.exports = Claudoku;
  else global.Claudoku = Claudoku;
