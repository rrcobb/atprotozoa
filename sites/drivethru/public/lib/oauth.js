// oauth.js — browser-side atproto OAuth (public client), for bisks.net/drivethru.
//
// Copied and trimmed from slop-shop/public/lib/oauth.js (same repo), itself
...
// the /drivethru mount prefix baked in — location.origin alone drops it. MOUNT
...
const MOUNT = location.pathname.startsWith("/drivethru") ? "/drivethru" : "";
