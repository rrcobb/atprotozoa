// biskshow Worker — mounted at bisks.net/games/biskshow/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/biskshow" mount prefix before handing the request to
