// mootkombat Worker — mounted at bisks.net/games/mootkombat/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/mootkombat" mount prefix before handing the request
