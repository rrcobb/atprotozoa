// mahjong-solitaire Worker — mounted at bisks.net/mahjong-solitaire/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/mahjong-solitaire" mount prefix before handing the request to the
...
const PREFIX = "/mahjong-solitaire";
