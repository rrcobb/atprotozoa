...
// cursor walk one page at a time. One request gets every record of a given
// type an account has ever written, in one shot — no per-page cap (see
...
// data"). Copied from sites/kevinmoot's lib/car.js (itself from
// sites/backscroll via sites/activitygrid/ngmi/beefcheck). Used here twice:
// moots.js pulls app.bsky.graph.follow records to compute a mutual-follow
// set, and vote-backfill.js pulls net.bisks.influential25.vote records to
// backfill the influence board — same function, different `types`.
//
