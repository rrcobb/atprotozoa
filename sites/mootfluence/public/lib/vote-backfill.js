// vote-backfill.js — true network-wide history of net.bisky.influential25.vote
// records, for mootfluence's moot-ranking read. Copied from
// sites/influential25/lib/global-backfill.js (copy, don't abstract) — same
// collection, same reasoning: a live Jetstream subscription only ever sees
// votes cast after this tab opened, which would leave a freshly-loaded
// moot ranking honestly incomplete. This walks every repo that has ever
// written a vote record and folds its full history in.
//
...
//
// Progress persists via vote-store.js's meta store so a repeat visit resumes
