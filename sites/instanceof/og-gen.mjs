...
// instanceof.bisks.net. Hand-drawn SVG, rasterised with @resvg/resvg-js and
// skyclone's bundled JetBrains Mono font (no system Chromium/fontconfig
// needed). Same recipe as sites/fieldguide/og-gen.mjs and sites/ontology/og-gen.mjs.
//
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="108" font-family="JetBrains Mono" font-weight="800" font-size="46" fill="${INK}">instanceof</text>
  <text x="64" y="150" font-family="JetBrains Mono" font-size="21" fill="${MUTED}">a history of ontology, philosophical and formal</text>
  <text x="64" y="182" font-family="JetBrains Mono" font-size="16" fill="${MUTED}">Parmenides &#8594; Porphyry's tree &#8594; Kant &#8594; Gruber &#8594; the Semantic Web &#8594; Wikidata</text>

  <line x1="64" y1="220" x2="${W - 64}" y2="220" stroke="${INK}" stroke-width="2"/>

  ${ticks}

  <text x="64" y="560" font-family="JetBrains Mono" font-weight="700" font-size="20" fill="${ACCENT}">instanceof.bisks.net</text>
  <text x="64" y="588" font-family="JetBrains Mono" font-size="15" fill="${MUTED}">plus a live tool that climbs Wikidata's own class tree for anything you type</text>
</svg>`;
