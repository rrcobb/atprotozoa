...
// (api.bsky.app, CORS *, no auth). Copied and trimmed from
// clustercrawl/lib/cluster.js (itself from simcluster/neighborhood) — copy,
// don't abstract. Unlike cluster.js's moots(), this does NOT widen the pool
// to plain follows when the mutual count is small: mootrace's whole premise
// is "your mutuals," not a padded-out lookalike set.
