// oauth.js — browser-side atproto OAuth (public client), for clusterpedia.bisks.net.
//
// Copied and trimmed from sites/padmoot/public/lib/oauth.js (same repo), itself
...
// narrowed to create-only on our own net.bisks.clusterpedia.* collections —
// no account-wide access. Must stay in lockstep with client-metadata.json.
...
const ORIGIN = location.origin; // https://clusterpedia.bisks.net (or localhost in dev)
export const MOUNT = ""; // canonical host is clusterpedia.bisks.net — no path mount
...
const SCOPE =
  "atproto repo:net.bisks.clusterpedia.revision?action=create repo:net.bisks.clusterpedia.talk?action=create";
...
const DB_NAME = "clusterpedia-oauth";
const STORE = "session";
