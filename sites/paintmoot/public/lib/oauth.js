// oauth.js — browser-side atproto OAuth (public client), for paintmoot.bisks.net.
//
// Copied and trimmed from trigrams/public/lib/oauth.js (same repo), which was
// itself adapted from mino.mobi's airchat/oauth/flow.js. Public client:
...
// narrowed to create-only on our own net.bisks.paintmoot.* collections — no
...
const SCOPE =
  "atproto repo:net.bisks.paintmoot.board?action=create repo:net.bisks.paintmoot.mark?action=create";
