...
// repo (every post, not a capped recent-history sample) can be pulled
// straight from the source over com.atproto.sync.getRepo. Copied and trimmed
// from sites/metamoots's lib/identity.js (copy, don't abstract) — ceemilarity
// only needs the PDS lookup, not that file's follow-graph/profile-batch
// machinery.
