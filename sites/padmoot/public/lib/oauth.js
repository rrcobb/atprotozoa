...
// narrowed to create+update on our own net.bisks.padmoot.pattern collection
...
const SCOPE = "atproto repo:net.bisks.padmoot.pattern?action=create&action=update";
