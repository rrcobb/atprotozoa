// oauth.js — browser-side atproto OAuth (public client), for hashteams.bisks.net.
//
// Copied and adapted from sites/witness/public/lib/oauth.js (same repo),
...
//
// Scope: narrowed per notes/50-oauth-scopes.md — hashteams only ever creates
// one net.bisks.hashteams.member record (no blob, no other collection). Must
...
const ORIGIN = location.origin; // https://hashteams.bisks.net (or localhost in dev)
const MOUNT = "";
...
const SCOPE = "atproto repo:net.bisks.hashteams.member?action=create";
