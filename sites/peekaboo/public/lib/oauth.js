// oauth.js — browser-side atproto OAuth (public client), for peekaboo.bisks.net.
//
// Copied and trimmed from sites/drivethru/public/lib/oauth.js (same repo),
// itself descended from slop-shop / trigrams / mino.mobi's airchat/oauth/flow.js.
// Public client:
...
//
// Scope is narrowed to create-only on app.bsky.feed.like — peekaboo only ever
// likes a post on your behalf (the reveal mechanic), never unlikes, posts, or
// touches anything else. Must stay in lockstep with client-metadata.json.
...
const MOUNT = ""; // canonical host is peekaboo.bisks.net, served at the root
...
const SCOPE = "atproto repo:app.bsky.feed.like?action=create";
