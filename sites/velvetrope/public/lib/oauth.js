// oauth.js — browser-side atproto OAuth (public client), for velvetrope.bisks.net.
//
// Copied and trimmed from sites/clusterpedia/public/lib/oauth.js (same repo),
// itself from sites/padmoot, adapted from trigrams/public/lib/oauth.js /
...
const ORIGIN = location.origin; // https://velvetrope.bisks.net (or localhost in dev)
