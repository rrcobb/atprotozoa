...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="310" font-family="JetBrains Mono" font-size="16" fill="${DIM}">repeat offenders, and 544 real build</text>
  <text x="64" y="336" font-family="JetBrains Mono" font-size="16" fill="${DIM}">records — nothing here is invented.</text>

  <text x="64" y="440" font-family="JetBrains Mono" font-size="16" fill="${GOLD}">544 asks, sorted by embarrassment</text>
