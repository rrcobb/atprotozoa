// cutitclose Worker — mounted at bisks.net/games/cutitclose/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/cutitclose" mount prefix before handing the request
