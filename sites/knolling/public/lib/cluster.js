// cluster.js — turn a Bluesky handle into a pool of accounts to scatter on the
// worktop. Reads Bluesky's PUBLIC AppView anonymously (api.bsky.app, CORS *,
// no auth). Copied and trimmed from mootdrone/lib/cluster.js, itself from
// clustercrawl, itself from simcluster/lib/moots.js — copy, don't abstract.
...
const MIN_POOL = 6; // below this, widen mutuals → follows so the desk isn't bare
...
// mutual set is too small to stock a worktop.
