// oauth.js — browser-side atproto OAuth (public client), for goodsky.bisks.net.
//
...
const ORIGIN = location.origin; // https://goodsky.bisks.net (or localhost in dev)
const MOUNT = "";
