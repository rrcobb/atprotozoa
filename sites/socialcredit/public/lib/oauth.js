// oauth.js — browser-side atproto OAuth (public client), for socialcredit.bisks.net.
//
// Copied and trimmed from sites/quadrants/public/lib/oauth.js (same repo, same
// pattern, itself from padmoot). Public client:
...
// narrowed to our own net.bisks.socialcredit.vote collection, create-only —
// no account-wide access, no update/delete (a vote is permanent once cast).
...
const ORIGIN = location.origin; // https://socialcredit.bisks.net (or localhost in dev)
export const MOUNT = ""; // canonical host is socialcredit.bisks.net — brand new site, no legacy path route
...
export const SCOPE = "atproto repo:net.bisks.socialcredit.vote?action=create";
...
const DB_NAME = "socialcredit-oauth";
const STORE = "session";
