// alignment-chart Worker — mounted at bisks.net/alignment-chart/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/alignment-chart" mount prefix before handing the request to
