// Generates public/og.png — the Open Graph preview card for thrashradar.
...
// sites/thrashmeter/og-gen.mjs (this site's own lineage; that file cites
// sites/intrigue/og-gen.mjs and sites/didscope's before it).
//
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="64" y="140" font-family="JetBrains Mono" font-weight="800" font-size="60" fill="url(#title)">thrashradar</text>
  <text x="64" y="188" font-family="JetBrains Mono" font-size="21" fill="${DIM}">the thrash leaderboard that</text>
  <text x="64" y="216" font-family="JetBrains Mono" font-size="21" fill="${DIM}">finds itself, out of <tspan fill="${ACCENT2}">100</tspan></text>

  <text x="64" y="290" font-family="JetBrains Mono" font-size="17" fill="${DIM}">Watches the live firehose for</text>
  <text x="64" y="316" font-family="JetBrains Mono" font-size="17" fill="${DIM}">bursty posting, then reads the</text>
  <text x="64" y="342" font-family="JetBrains Mono" font-size="17" fill="${DIM}">whole repo — same rules as</text>
  <text x="64" y="368" font-family="JetBrains Mono" font-size="17" fill="${DIM}">thrashmeter, found on its own.</text>

  <text x="64" y="560" font-family="JetBrains Mono" font-weight="700" font-size="20" fill="${ACCENT2}">thrashradar.bisks.net</text>
