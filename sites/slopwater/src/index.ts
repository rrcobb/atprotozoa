// SLOP WATER Worker — mounted at bisks.net/games/slopwater/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/slopwater" mount prefix before handing the request
