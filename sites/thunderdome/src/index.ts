// thunderdome Worker — mounted at bisks.net/games/thunderdome/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/thunderdome" mount prefix before handing the request
// to the static-asset router, since the assets directory has no idea it's not
...
const PREFIX = "/games/thunderdome";
