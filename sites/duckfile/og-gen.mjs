...
<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  ${node(nA.x, nA.y, 170, 62, "norvid-studies", "requester, allegedly the victim")}
  ${node(nB.x, nB.y, 170, 62, "the algorithm", "shows them to each other")}
  ${node(nC.x, nC.y, 170, 62, "$BRKTHRU", "not a real token (yet)")}
  ${node(nD.x, nD.y, 170, 62, "croissanthology.com", "rendered as a duck")}

  <!-- duck stamp, near the croissanthology node -->
  <text x="${nD.x + 105}" y="${nD.y + 6}" font-size="34">🦆</text>
  ...
  <g>
    ...
    <text x="640" y="175" font-family="JetBrains Mono" font-weight="700" font-size="19" fill="${RED}" letter-spacing="2" transform="rotate(1.5 880 315)">DECLASSIFIED — AT MAXIMUM HYPE</text>
    <text x="640" y="250" font-family="JetBrains Mono" font-weight="900" font-size="64" fill="${INK}" transform="rotate(1.5 880 315)">THE DUCK</text>
    <text x="640" y="316" font-family="JetBrains Mono" font-weight="900" font-size="56" fill="${RED_BRIGHT}" transform="rotate(1.5 880 315)">FILE</text>
    <text x="640" y="360" font-family="JetBrains Mono" font-size="19" fill="#3a2a1a" transform="rotate(1.5 880 315)">the norvid-studies /</text>
    <text x="640" y="388" font-family="JetBrains Mono" font-size="19" fill="#3a2a1a" transform="rotate(1.5 880 315)">croissanthology.com beef.</text>
    <text x="640" y="430" font-family="JetBrains Mono" font-weight="700" font-size="19" fill="${RED}" transform="rotate(1.5 880 315)">spare no expense.</text>
    <text x="640" y="458" font-family="JetBrains Mono" font-weight="700" font-size="19" fill="${DUCK}" transform="rotate(1.5 880 315)">do a breakthrough.</text>
    <text x="640" y="512" font-family="JetBrains Mono" font-size="17" fill="#5a4a3a" transform="rotate(1.5 880 315)">duckfile.bisks.net</text>
  </g>
</svg>`;
