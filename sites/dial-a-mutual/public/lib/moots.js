...
// followers), and fetch one moot's latest original post so it can be "played
// back" like an answering-machine message. Reads Bluesky's PUBLIC AppView
// anonymously (public.api.bsky.app, CORS *, no auth): resolveHandle,
// getFollows, getFollowers, getProfile, getAuthorFeed. Copied+trimmed from
// moot-bingo/lib/moots.js and mootkombat/lib/moots.js (copy, don't abstract).
