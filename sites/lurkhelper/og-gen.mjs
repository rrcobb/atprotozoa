...
// lurkhelper link. Hand-drawn SVG, rasterised with @resvg/resvg-js and
// skyclone's bundled JetBrains Mono font (no system Chromium/fontconfig
// needed). Same recipe as sites/followwall/og-gen.mjs.
//
...
const W = 1200, H = 630;
const BG = "#0a1614", INK = "#eafff4", MUTED = "#7fae9e";
const ACCENT = "#5eead4", ACCENT2 = "#fbbf24";
const CARD = "#0f211f", BORDER = "#1c3a35";
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  <defs>
    <radialGradient id="glow1" cx="50%" cy="-5%" r="60%">
      <stop offset="0" stop-color="#123a35"/>
  ...
  <text x="60" y="118" font-family="JetBrains Mono" font-weight="800" font-size="64" fill="${ACCENT}">👀 lurkhelper</text>
  <text x="64" y="164" font-family="JetBrains Mono" font-size="22" fill="${MUTED}">find the followers who never say anything</text>

  <rect x="64" y="200" width="1072" height="1" fill="${BORDER}"/>

  <text x="64" y="248" font-family="JetBrains Mono" font-size="20" fill="${INK}">Enter a handle → we find who never likes, reposts, or replies →</text>
  <text x="64" y="278" font-family="JetBrains Mono" font-weight="700" font-size="20" fill="${ACCENT2}">and give you a one-tap way to say hi.</text>

  ${mosaic}

  <text x="64" y="588" font-family="JetBrains Mono" font-size="16" fill="${MUTED}">lurkhelper.bisks.net</text>
</svg>`;
