// Generates public/og.png — the Open Graph preview card for beanjar.
//
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <!-- wordmark -->
  <text x="630" y="220" font-family="JetBrains Mono" font-weight="800" font-size="58" fill="${INK}">jar of beans</text>
  <text x="630" y="262" font-family="JetBrains Mono" font-size="19" fill="${MUTED}">shake it — real physics,</text>
  <text x="630" y="290" font-family="JetBrains Mono" font-size="19" fill="${MUTED}">real synthesized sound</text>

  <text x="630" y="352" font-family="JetBrains Mono" font-size="18" fill="${ACCENT}">drag the jar to shake it</text>
  <text x="630" y="386" font-family="JetBrains Mono" font-size="18" fill="${MUTED}">mash the SHAKE! button</text>
  <text x="630" y="420" font-family="JetBrains Mono" font-size="18" fill="${MUTED}">or shake your actual phone</text>
  ...
  <text x="630" y="560" font-family="JetBrains Mono" font-weight="700" font-size="22" fill="${ACCENT}">bisks.net/beanjar</text>
</svg>`;
