// identity.js — resolve an account's PDS from its DID document, so a moot's
...
// Copied and trimmed from sites/ngmi's lib/identity.js (copy, don't
// abstract) — backscroll only needs the PDS lookup.
