// blackice Worker — mounted at bisks.net/games/blackice/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/games/blackice" mount prefix before handing the request to
