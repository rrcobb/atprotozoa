// slate38-store.js — the on-site vote's entire "backend": an IndexedDB cache
// of every accepted net.bisks.slate38.vote endorsement derived from the live
...
// replaying, same shape as sites/influential25's i25-store.js (copy, don't
// abstract — see notes/40-new-site-playbook.md).
//
// Two object stores:
//   votes — every accepted net.bisks.slate38.vote record, keyed by the at://
//           uri of the record that cast it
//   meta  — small keyed values: the Jetstream resume cursor, backfill state

const DB_NAME = "slate38-vote-store";
const DB_VERSION = 1;
