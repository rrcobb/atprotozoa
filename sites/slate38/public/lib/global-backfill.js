// global-backfill.js — true network-wide history for THE SLATE's on-site
// vote. slate38-vote-client.js's live Jetstream subscription only ever sees
// endorsements cast after a visitor's short backfill window, which would
...
// has ever written a net.bisks.slate38.vote record and folds its full
// history in, so a fresh visitor's board stops depending on how long
// they've had the page open.
//
// Two-step discovery, same shape as sites/influential25's global-backfill.js
// (the reference implementation this was copied from — see
...
//
// Progress persists via slate38-store.js's meta store so a repeat visit
...
const COLLECTION = "net.bisks.slate38.vote";
