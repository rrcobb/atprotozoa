// oauth.js — browser-side atproto OAuth (public client), for keytags.bisks.net.
//
// Copied from paintmoot/public/lib/oauth.js (same repo), itself trimmed from
// trigrams/public/lib/oauth.js and adapted from mino.mobi's
...
// narrowed to our own net.bisks.keytags.set collection only — no
...
const SCOPE = "atproto repo:net.bisks.keytags.set";
