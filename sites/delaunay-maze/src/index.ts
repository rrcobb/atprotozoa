// delaunay-maze Worker — mounted at bisks.net/delaunay-maze/ (see
// notes/40-new-site-playbook.md). Pure static site; the only server job is
// stripping the "/delaunay-maze" mount prefix before handing the request to the
