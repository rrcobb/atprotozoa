// oauth.js — browser-side atproto OAuth (public client), for mutualpulse.bisks.net.
//
...
const ORIGIN = location.origin; // https://mutualpulse.bisks.net (or localhost in dev)
const MOUNT = "";
...
const DB_NAME = "mutualpulse-oauth";
const STORE = "session";
...
export async function completeLoginIfCallback() {
  ...
  // user started the flow from a non-root page (/pulse/<did>/<rkey>) a
