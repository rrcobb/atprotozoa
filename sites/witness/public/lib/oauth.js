// oauth.js — browser-side atproto OAuth (public client), for witness.bisks.net.
//
// Copied and adapted from sites/shelfguessr/public/lib/oauth.js (same repo),
...
//
// Scope: narrowed per notes/50-oauth-scopes.md — witness only ever creates
// net.bisks.witness.entry records and uploads an optional photo blob. Must
// match public/client-metadata.json's `scope` field exactly.
...
const ORIGIN = location.origin; // https://witness.bisks.net (or localhost in dev)
const MOUNT = "";
...
const SCOPE = "atproto repo:net.bisks.witness.entry?action=create blob:image/*";
