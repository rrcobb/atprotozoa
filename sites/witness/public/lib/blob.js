// blob.js — upload an optional witness-entry photo to the logged-in user's
// own repo.
//
// Copy, don't abstract: trimmed from sites/shelfguessr/public/lib/blob.js
// (itself from sites/catspace). Writes go through the OAuth session's
// dpopFetch.
