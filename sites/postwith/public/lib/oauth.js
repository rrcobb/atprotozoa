...
// Mounted at bisks.net/postwith — location.origin alone drops the path, so the
// mount prefix has to be appended for any URL postwith writes about itself.
export const MOUNT = "/postwith";
